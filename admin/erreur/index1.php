				 	...
				 	<tbody>
				 		<?php
							...
							while($item = $statement->fetch())
							{
				 			...
				 			echo '<td>'. $item['descrition].'</td>';
				 			echo '<td>'. $item['price].'</td>';
				 			echo '<td>'. $item['category].'</td>';
				 			echo '<td width="300px">
				 				<a class="btn btn-default" href="view.php?id='.$item['id'] .'"><span class="glyphicon glyphicon-eye-open "></span> Voir</a>
				 				<a class="btn btn-primary" href="insert.php?id=1"><span class="glyphicon glyphicon-pencil "></span> Modifier</a>
